...
model_input1 = Input(shape=(None, word2vec.vector_size))
model_input2 = Input(shape=(None, word2vec.vector_size))
model_input3 = Input(shape=(None, word2vec.vector_size))
